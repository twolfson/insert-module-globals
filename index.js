...
// DEV: Need to find out where the queue comes from and goes to and
// what the deal is with the {id, source, deps}
// as techincally, we should have a programatic require
